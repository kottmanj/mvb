...
M_tot = compute_num_meas(wfn, is_hcb=True, hcb_mol=hcb_mol, debug=False, n_repetitions=100)
...
for i,rotation in enumerate(new_rotations):
    _, mol, approx, _ = rotate_and_hcb(UR=rotation.get_UR_circuit(), circuit=U,
